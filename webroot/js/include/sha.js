 ...
 */
! function(n, r) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = r() : "function" == typeof define && define.amd ? define(r) : (n = n || self).jsSHA = r()
}(this, (function() {
    "use strict";
            ...
            case "TEXT":
                return function(n, r, t) {
                    return function(n, r, t, e, i) {
                        var o, u, f, w, s, a, h, c, v = 0,
                            A = t || [0],
                            E = (e = e || 0) >>> 3;
                        if ("UTF8" === r)
                            for (h = -1 === i ? 3 : 0, f = 0; f < n.length; f += 1)
                                for (u = [], 128 > (o = n.charCodeAt(f)) ? u.push(o) : 2048 > o ? (u.push(192 | o >>> 6), u.push(128 | 63 & o)) : 55296 > o || 57344 <= o ? u.push(224 | o >>> 12, 128 | o >>> 6 & 63, 128 | 63 & o) : (f += 1, o = 65536 + ((1023 & o) << 10 | 1023 & n.charCodeAt(f)), u.push(240 | o >>> 18, 128 | o >>> 12 & 63, 128 | o >>> 6 & 63, 128 | 63 & o)), w = 0; w < u.length; w += 1) {
                ...
                return function(r) {
                    return function(r, t, e, i) {
                        var o, u, f, w, s, a = "",
                            ...
                            c = -1 === e ? 3 : 0;
                        for (o = 0; o < h; o += 3)
                            for (w = o + 1 < h ? r[o + 1 >>> 2] : 0, s = o + 2 < h ? r[o + 2 >>> 2] : 0, f = (r[o >>> 2] >>> 8 * (c + e * (o % 4)) & 255) << 16 | (w >>> 8 * (c + e * ((o + 1) % 4)) & 255) << 8 | s >>> 8 * (c + e * ((o + 2) % 4)) & 255, u = 0; u < 4; u += 1) a += 8 * o + 6 * u <= t ? n.charAt(f >>> 6 * (3 - u) & 63) : i.b64Pad;
                        return a
                    }(r, t, e, i)
                };
            case "BYTES":
    ...
    var h = function() {
            ...
            return n.prototype.update = function(n) {
                var r, t = 0,
                    ...
                    u = i.value,
                    f = o >>> 5;
                for (r = 0; r < f; r += e) t + this.S <= o && (this.p = this.R(u.slice(r, r + e), this.p), t += this.S);
                ...
                for (i = this.K(this.u.slice(), this.s, this.v, this.B(this.p), o), t = 1; t < this.numRounds; t += 1) !0 === this.C && o % 32 != 0 && (i[i.length - 1] &= 16777215 >>> 24 - o % 32), i = this.K(i, o, 0, this.L(this.o), o);
                return f(i)
            }, n.prototype.setHMACKey = function(n, r, e) {
                if (!0 !== this.g) throw new Error("Variant does not support HMAC");
                if (!0 === this.h) throw new Error("Cannot set MAC key after calling update");
                ...
                var n;
                if (!1 === this.A) throw new Error("Cannot call getHMAC without first setting MAC key");
                var r = this.K(this.u.slice(), this.s, this.v, this.B(this.p), this.U);
    ...
    function T(n, r) {
        var t, e, i, o, u, f, w, s = [];
        for (t = r[0], e = r[1], i = r[2], o = r[3], u = r[4], w = 0; w < 80; w += 1) s[w] = w < 16 ? n[w] : A(s[w - 3] ^ s[w - 8] ^ s[w - 14] ^ s[w - 16], 1), f = w < 20 ? y(A(t, 5), H(e, i, o), u, 1518500249, s[w]) : w < 40 ? y(A(t, 5), b(e, i, o), u, 1859775393, s[w]) : w < 60 ? y(A(t, 5), S(e, i, o), u, 2400959708, s[w]) : y(A(t, 5), b(e, i, o), u, 3395469782, s[w]), u = o, o = i, i = A(e, 30), e = t, t = f;
        return r[0] = m(t, r[0]), r[1] = m(e, r[1]), r[2] = m(i, r[2]), r[3] = m(o, r[3]), r[4] = m(u, r[4]), r
    }

    function F(n, r, t, e) {
        for (var i, o = 15 + (r + 65 >>> 9 << 4), u = r + t; n.length <= o;) n.push(0);
        for (n[r >>> 5] |= 128 << 24 - r % 32, n[o] = 4294967295 & u, n[o - 1] = u / 4294967296 | 0, i = 0; i < n.length; i += 16) e = T(n.slice(i, i + 16), e);
        return e
    }
    var K = function(n) {
        function r(r, e, i) {
            ...
            var u = i || {};
            return (o = n.call(this, r, e, i) || this).g = !0, o.F = o.Y, o.T = -1, o.m = t(o.t, o.i, o.T), o.R = T, o.B = function(n) {
                return n.slice()
            }, o.L = C, o.K = F, o.p = [1732584193, 4023233417, 2562383102, 271733878, 3285377520], o.S = 512, o.U = 160, o.C = !1, u.hmacKey && o.k(a("hmacKey", u.hmacKey, o.T)), o
        }
        return v(r, n), r
    }(h);
    ...
    function L(n, r) {
        ...
        for (t = r[0], e = r[1], o = r[2], u = r[3], f = r[4], w = r[5], s = r[6], a = r[7], v = 0; v < 64; v += 1) b[v] = v < 16 ? n[v] : p(E(A = b[v - 2], 17) ^ E(A, 19) ^ l(A, 10), b[v - 7], R(b[v - 15]), b[v - 16]), h = y(a, U(f), H(f, w, s), i[v], b[v]), c = m(d(t), S(t, e, o)), a = s, s = w, w = f, f = m(u, h), u = o, o = e, e = t, t = m(h, c);
        return r[0] = m(t, r[0]), r[1] = m(e, r[1]), r[2] = m(o, r[2]), r[3] = m(u, r[3]), r[4] = m(f, r[4]), r[5] = m(w, r[5]), r[6] = m(s, r[6]), r[7] = m(a, r[7]), r
    }
    var g = function(n) {
            function r(r, e, i) {
                var o = this;
                ...
                var u = i || {};
                return (o = n.call(this, r, e, i) || this).F = o.Y, o.g = !0, o.T = -1, o.m = t(o.t, o.i, o.T), o.R = L, o.B = function(n) {
                    return n.slice()
                ...
                }, o.p = B(r), o.S = 512, o.U = "SHA-224" === r ? 224 : 256, o.C = !1, u.hmacKey && o.k(a("hmacKey", u.hmacKey, o.T)), o
            }
            return v(r, n), r
        }(h),
        k = function(n, r) {
    ...
    var G = function(n) {
            function r(r, e, i) {
                ...
                var u = i || {};
                return (o = n.call(this, r, e, i) || this).F = o.Y, o.g = !0, o.T = -1, o.m = t(o.t, o.i, o.T), o.R = D, o.B = function(n) {
                    return n.slice()
                ...
                }, o.p = q(r), o.S = 1024, o.U = "SHA-384" === r ? 384 : 512, o.C = !1, u.hmacKey && o.k(a("hmacKey", u.hmacKey, o.T)), o
            }
            return v(r, n), r
        }(h),
    ...
    function nn(n, r) {
        var t, e, i, o, u, f, w, s, a, h = [],
            c = [];
        if (null !== n)
            for (e = 0; e < n.length; e += 2) r[(e >>> 1) % 5][(e >>> 1) / 5 | 0] = P(r[(e >>> 1) % 5][(e >>> 1) / 5 | 0], new k(n[e + 1], n[e]));
        for (t = 0; t < 24; t += 1) {
            ...
            for (e = 0; e < 5; e += 1)
                for (i = 0; i < 5; i += 1) o[i][(2 * e + 3 * i) % 5] = Y(r[e][i], Q[e][i]);
            for (e = 0; e < 5; e += 1)
                for (i = 0; i < 5; i += 1) r[e][i] = P(o[e][i], new k(~o[(e + 1) % 5][i].N & o[(e + 2) % 5][i].N, ~o[(e + 1) % 5][i].I & o[(e + 2) % 5][i].I));
            r[0][0] = P(r[0][0], J[t])
        }
        return r
    }
    ...
    var on = function(n) {
        function r(r, e, i) {
            ...
            switch (o.T = 1, o.m = t(o.t, o.i, o.T), o.R = nn, o.B = $, o.L = W, o.p = W(), o.C = !1, r) {
                case "SHA3-224":
                ...
                case "SHA3-512":
                    ...
                    break;
                case "SHAKE128":
                    u = 31, o.S = w = 1344, o.U = -1, o.C = !0, o.g = !1, o.F = null;
                    break;
                case "SHAKE256":
                    u = 31, o.S = w = 1088, o.U = -1, o.C = !0, o.g = !1, o.F = null;
                    break;
                case "KMAC128":
                    u = 4, o.S = w = 1344, o.M(i), o.U = -1, o.C = !0, o.g = !1, o.F = o.X;
                    break;
                case "KMAC256":
                    u = 4, o.S = w = 1088, o.M(i), o.U = -1, o.C = !0, o.g = !1, o.F = o.X;
                    break;
                case "CSHAKE128":
                    o.S = w = 1344, u = o.O(i), o.U = -1, o.C = !0, o.g = !1, o.F = null;
                    break;
                case "CSHAKE256":
                    o.S = w = 1088, u = o.O(i), o.U = -1, o.C = !0, o.g = !1, o.F = null;
                    break;
                default:
                    throw new Error(f)
            }
            ...
            }, s.hmacKey && o.k(a("hmacKey", s.hmacKey, o.T)), o
        }
        return v(r, n), r.prototype.O = function(n, r) {
            ...
            if (0 !== t.customization.binLen || 0 !== t.funcName.binLen) {
                for (var i = en(e, this.S >>> 3), o = 0; o < i.length; o += this.S >>> 5) this.p = this.R(i.slice(o, o + (this.S >>> 5)), this.p), this.v += this.S;
                return 4
            }
            return 31
            ...
            this.O(n, r.funcName);
            for (var t = en(tn(r.kmacKey), this.S >>> 3), e = 0; e < t.length; e += this.S >>> 5) this.p = this.R(t.slice(e, e + (this.S >>> 5)), this.p), this.v += this.S;
            this.A = !0
